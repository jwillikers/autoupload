...
[,sh]
----
curl --fail --location --show-error --silent https://pkgs.tailscale.com/stable/debian/bookworm.noarmor.gpg \
...
[,sh]
----
curl --fail --location --show-error --silent https://pkgs.tailscale.com/stable/debian/bookworm.tailscale-keyring.list \
...
Licensed under the MIT license (link:LICENSE-MIT[LICENSE] or http://opensource.org/licenses/MIT).
