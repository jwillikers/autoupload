...
{Tailscale} is used to access the storage services remotely.
The instructions here install and enable Tailscale and the {Tailscale-Online-Target}.
...
[,sh]
----
curl --fail --location --show-error --silent https://pkgs.tailscale.com/stable/debian/$(lsb_release --codename --short).noarmor.gpg \
...
[,sh]
----
curl --fail --location --show-error --silent https://pkgs.tailscale.com/stable/debian/$(lsb_release --codename --short).tailscale-keyring.list \
...
[,sh]
----
systemctl --user enable --now autoupload-immich@$(systemd-escape --path /home/pi-camera/Pictures).path
----
...
[,sh]
----
systemctl --user enable --now autoupload-rclone@$(systemd-escape --path /home/pi-camera/Pictures).path
----
